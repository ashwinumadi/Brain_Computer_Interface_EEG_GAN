...
Folders : 
	...
	3. Chikoo : Contains the images that are generated during the testing phase. - (After second.py file execution)
Files : 
	1. first.py : Run this file first. GAN model training. 
	2. second.py : Run this file second. GAN model testing.
